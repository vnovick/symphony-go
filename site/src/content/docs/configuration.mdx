...
| `resume_prompt` | string | built-in | Liquid template sent to Claude resume turns instead of re-sending the full workflow prompt. Applies to Claude turn 2+ and manual pause/resume. |
